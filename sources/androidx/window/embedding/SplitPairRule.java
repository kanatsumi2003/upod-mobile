...
public final class SplitPairRule extends SplitRule {
    ...
    public SplitPairRule(Set<SplitPairFilter> set, boolean z3, boolean z4, boolean z5, int i3, int i4, float f4, int i5) {
        super(i3, i4, f4, i5);
        i.e(set, "filters");
    ...
    public /* synthetic */ SplitPairRule(java.util.Set r8, boolean r9, boolean r10, boolean r11, int r12, int r13, float r14, int r15, int r16, kotlin.jvm.internal.e r17) {
        /*
            r7 = this;
            r0 = r16
            r1 = r0 & 2
        ...
        L_0x0034:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.window.embedding.SplitPairRule.<init>(java.util.Set, boolean, boolean, boolean, int, int, float, int, int, kotlin.jvm.internal.e):void");
    }
    ...
    public final SplitPairRule plus$window_release(SplitPairFilter splitPairFilter) {
        i.e(splitPairFilter, "filter");
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        linkedHashSet.addAll(this.filters);
        linkedHashSet.add(splitPairFilter);
        return new SplitPairRule(q.t(linkedHashSet), this.finishPrimaryWithSecondary, this.finishSecondaryWithPrimary, this.clearTop, getMinWidth(), getMinSmallestWidth(), getSplitRatio(), getLayoutDirection());
    }
}
