...
class l extends k {
    ...
    public static final Integer g(String str, int i3) {
        ...
        int i8 = -59652323;
        while (i7 < length) {
            int b4 = a.b(str.charAt(i7), i3);
            if (b4 < 0) {
                return null;
            }
            if ((i5 < i8 && (i8 != -59652323 || i5 < (i8 = i6 / i3))) || (i4 = i5 * i3) < i6 + b4) {
                return null;
            }
            i5 = i4 - b4;
            i7++;
    ...
    public static final java.lang.Long i(java.lang.String r18, int r19) {
        ...
        L_0x0014:
            ...
            r6 = 48
            int r6 = kotlin.jvm.internal.i.f(r5, r6)
        ...
        L_0x007f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: z2.l.i(java.lang.String, int):java.lang.Long");
    }
}
